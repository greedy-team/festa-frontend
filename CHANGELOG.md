...
**기타**
- Merge pull request from greedy-team/fix_267_프론트_화면과_응답_처리를_백엔드_계약과_확정_정책에_맞춘다
- docs : 리포트 문서 작성
- docs : 백엔드 계약 반영 이슈 문서 추가
- fix : nullable 응답과 모바일 제목 표시 보정
- fix : 축제 폼에서 전체 주최 조회
- fix : 아티스트 검수 필요 필드 제거
...
**기타**
- Merge pull request from greedy-team/chore_263_readme_버전_업데이트의_보호_브랜치_직접_푸시_제거
- chore : README 버전 업데이트의 보호 브랜치 직접 푸시 제거
...
**기타**
- Merge pull request from greedy-team/feat_259_검색_결과_제목에_학교명_연도를_넣고_구조화_데이터를_추가한다
- docs : 리포트 문서 작성
- docs : 검색 노출 강화 이슈 문서 작성
- feat : 검색 결과 제목에 학교명·연도를 넣고 구조화 데이터 추가
...
**기타**
- Merge pull request from greedy-team/feat_246_clarity_재생에서_화면_내용이_보이도록_마스킹을_해제
- docs : 리포트 문서 작성
- feat : Clarity 재생에서 화면 내용이 보이도록 마스킹 해제
...
**기타**
- Merge pull request from greedy-team/feat_242_출연_이력_항목에서_축제_상세로_이동한다
- docs : 리포트 문서 작성
- feat : 출연 이력 항목에서 축제 상세로 이동
...
**기타**
- Merge pull request from greedy-team/feat_238_정책_확정값_반영과_첫_방문_이용_고지_모달
- docs : 리포트 문서 작성
- feat : 첫 방문 약관 적용 고지 모달 추가
- feat : 개인정보 처리방침·이용약관·저작권 정책 확정값 반영
...
**기타**
- Merge pull request from greedy-team/feat_233_분석_수집_동의와_ga4_clarity_활성화
- feat : GA4·Clarity 분석 동의와 수집 경계 구현
- Merge pull request from greedy-team/feat_220_lighthouse_성능_개선과_사용자_행동_분석
- docs : 리포트 문서 작성
- docs : Lighthouse 측정 근거와 후속 이슈 정리
- feat : GA4와 Clarity 분석 연결 기반 추가
- Merge pull request from greedy-team/fix_211_네이버_사이트_소유확인_실패
- Merge pull request from greedy-team/feat_228_이용약관_개인정보_처리방침_페이지_추가
- Merge pull request from greedy-team/feat_223_저작권_정책_페이지_문구_작성
- feat : 이용약관·개인정보 처리방침 페이지 추가 (festa-brain 01·03번 조문 반영)
- feat : 이용약관·개인정보처리방침 페이지 이슈 초안 추가
- feat : 저작권 정책 문구를 festa-brain 02번 조문 그대로 맞춘다
- Merge pull request from greedy-team/feat_225_축제_상세_히어로_축제명_글자_크기를_모바일에서_줄인다
- Merge pull request from greedy-team/feat_224_축제_전체_아티스트_목록_페이지_제목_글자_크기를_모바일에서_줄인다
- feat : 축제 상세 히어로 축제명을 모바일에서 축소
- feat : 축제 상세 히어로 축제명 모바일 글자 크기 축소 이슈 초안 추가
- feat : 축제 전체·아티스트 목록 제목을 모바일에서 축소
- feat : 축제 전체·아티스트 목록 제목 모바일 글자 크기 축소 이슈 초안 추가
- feat : 저작권 정책 페이지 문구 작성 (DEC-0191 반영)
- feat : 저작권 정책 페이지 문구 작성 이슈 초안 추가
- Merge pull request from greedy-team/feat_221_저작권_정책_페이지_추가
- feat : 저작권 정책 페이지에서 아티스트 이미지·로고 섹션 제외
- feat : 저작권 정책 페이지 뼈대 추가
- feat : 저작권 정책 페이지 이슈 초안 추가
- Merge pull request from greedy-team/feat_218_진행_중인_축제는_d_day를_종료일_기준으로_표기
- fix : 진행 중인 축제 D-day를 종료일 카운트다운이 아니라 D-DAY 고정으로 정정
- feat : 축제 상세 히어로도 D-day를 종료일 기준으로 계산
- feat : 진행 중인 축제 D-day 종료일 기준 표기 구현 보고서 추가
- feat : 진행 중인 축제는 D-day를 종료일 기준으로 표기
- feat : 진행 중인 축제 D-day 종료일 기준 표기 이슈 초안 추가
- Merge pull request from greedy-team/feat_216_nav_메뉴_홈_축제_아티스트_에_hover_시_글씨_확대_효과_추가
- feat : 헤더 nav 메뉴 hover 글씨 확대 효과 구현 보고서 추가
- feat : 헤더 nav 메뉴에 hover 시 글씨 확대 효과 추가
- feat : 헤더 nav 메뉴 hover 글씨 확대 효과 이슈 초안 추가
- Merge pull request from greedy-team/feat_214_모바일에서_최근_등록된_축제_를_4개만_노출
- feat : 모바일에서 최근 등록된 축제 4개만 노출 구현 보고서 추가
- feat : 모바일에서 최근 등록된 축제를 4개만 노출
- feat : 모바일에서 최근 등록된 축제 4개만 노출 이슈 초안 추가
- fix : 네이버 사이트 소유확인 파일 추가
