...
const VARIANT_CLASSES: Record<Variant, string> = {
  default: "h-[36px] w-[320px] max-w-full text-meta",
...
export function SearchPill({
  ...
  return (
    ...
    <div
      aria-hidden
      className={`inline-flex items-center justify-between rounded-pill bg-surface-field px-4 text-muted-soft ${VARIANT_CLASSES[variant]} ${className}`}
    >
