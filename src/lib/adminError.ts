...
export const ADMIN_ERROR_CODE = {
  ...
  IMPORT_EMPTY_CSV: "IMPORT_EMPTY_CSV",
  IMPORT_INVALID_CSV_ENCODING: "IMPORT_INVALID_CSV_ENCODING",
  ...
  IMPORT_INVALID_CONFLICT_POLICY: "IMPORT_INVALID_CONFLICT_POLICY",
  PAYLOAD_TOO_LARGE: "PAYLOAD_TOO_LARGE",
  IMPORT_NOT_FOUND: "IMPORT_NOT_FOUND",
  IMPORT_ALREADY_COMMITTED: "IMPORT_ALREADY_COMMITTED",
  IMPORT_EXPIRED: "IMPORT_EXPIRED",
  IMPORT_UNSUPPORTED_PREVIEW_VERSION: "IMPORT_UNSUPPORTED_PREVIEW_VERSION",
  IMPORT_INVALID_PREVIEW: "IMPORT_INVALID_PREVIEW",
  IMPORT_INVALID_LINE_SELECTION: "IMPORT_INVALID_LINE_SELECTION",
  IMPORT_UNCOMMITTABLE: "IMPORT_UNCOMMITTABLE",
...
const MESSAGES: Record<string, string> = {
  ...
  [ADMIN_ERROR_CODE.IMPORT_EMPTY_CSV]: "CSV에 데이터 행이 없습니다.",
  [ADMIN_ERROR_CODE.IMPORT_INVALID_CSV_ENCODING]:
    "CSV 인코딩이 올바르지 않습니다. UTF-8로 저장해 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_INVALID_CSV_HEADER]:
    "CSV 헤더가 예상과 다릅니다. 크롤러 산출물의 컬럼 구성을 확인해 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_INVALID_CSV]: "CSV를 읽을 수 없습니다. 파일을 확인해 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_MISSING_FILE]: "필수 파일이 빠졌습니다. festivals·lineups를 함께 올려 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_INVALID_TYPE]: "임포트 타입이 올바르지 않습니다.",
  [ADMIN_ERROR_CODE.IMPORT_INVALID_STATUS]: "이력 상태 필터가 올바르지 않습니다.",
  [ADMIN_ERROR_CODE.IMPORT_INVALID_CONFLICT_POLICY]: "충돌 처리 방식이 올바르지 않습니다.",
  [ADMIN_ERROR_CODE.PAYLOAD_TOO_LARGE]: "파일이 너무 큽니다.",
  [ADMIN_ERROR_CODE.IMPORT_NOT_FOUND]:
    "해당 임포트를 찾을 수 없습니다. 새로고침 후 다시 시도해 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_ALREADY_COMMITTED]: "이미 커밋된 임포트입니다.",
  [ADMIN_ERROR_CODE.IMPORT_EXPIRED]:
    "미리보기가 만료됐습니다(업로드 후 30분). 다시 업로드해 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_UNSUPPORTED_PREVIEW_VERSION]:
    "미리보기 형식 버전이 달라 커밋할 수 없습니다. 다시 업로드해 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_INVALID_PREVIEW]:
    "미리보기 데이터가 손상됐습니다. 다시 업로드해 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_INVALID_LINE_SELECTION]:
    "선택한 행이 미리보기와 맞지 않습니다. 새로고침 후 다시 선택해 주세요.",
  [ADMIN_ERROR_CODE.IMPORT_UNCOMMITTABLE]: "커밋할 수 있는 행이 없습니다.",
  [ADMIN_ERROR_CODE.IMPORT_PREVIEW_STALE]:
    "업로드 이후 데이터가 바뀌어 미리보기가 낡았습니다. 다시 업로드해 주세요.",
};
